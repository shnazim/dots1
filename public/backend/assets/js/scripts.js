(function ($) {
    ...
    $(document).on("click", ".process-alert", function () {
        var link = $(this).attr("href");
        var message = $(this).data("message");
        Swal.fire({
            text: message,
            ...
            confirmButtonColor: "#3085d6",
            cancelButtonColor: "#d33",
            confirmButtonText: $lang_yes_button_text,
            cancelButtonText: $lang_cancel_button_text,
        }).then((result) => {
            if (result.value) {
                window.location.href = link;
        ...
        $(".select2-ajax").each(function (i, obj) {
            ...
            $(this)
                .select2({
                    theme: "classic",
                    placeholder:
                        typeof $(this).data("placeholder") !== "undefined"
                ...
                .on("select2:open", () => {
                    ...
                    if (typeof $(this).data("href") !== "undefined") {
                        $(".select2-results:not(:has(a))").append(
                            '<p class="border-top m-0 p-2"><a class="' +
                                modal +
                                '" href="' +
                                $(this).data("href") +
                                '" data-title="' +
                                $(this).data("title") +
                                '" data-reload="false"><i class="fas fa-plus-circle mr-1"></i>' +
                                $lang_add_new +
                                "</a></p>"
                        );
                    }
    ...
    if ($(".select-customer select").length) {
        $(".select-customer select").each(function (i, obj) {
            var display2 = "";
            var divider = "";
            if (typeof $(this).data("display2") !== "undefined") {
                display2 = "&display2=" + $(this).data("display2");
            ...
            $(this)
                ...
                .on("select2:open", () => {
                    ...
                    if (typeof $(this).data("href") !== "undefined") {
                        $(".select2-results:not(:has(a))").append(
                            '<p class="border-top m-0 p-2"><a class="ajax-modal" href="' +
                                $(this).data("href") +
                                '" data-title="' +
                                $(this).data("title") +
                                '" data-reload="false"><i class="fas fa-plus-circle mr-1"></i>' +
    ...
    $(document).on("click", ".ajax-modal", function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                //Trigger Event
                $(document).trigger("ajax-modal-opened");

                if (fullscreen == true) {
                    $("#main_modal >.modal-dialog").addClass(
                        "fullscreen-modal"
                    );
                } else {
                    $("#main_modal >.modal-dialog").removeClass(
                        "fullscreen-modal"
                    );
                }
                ...
                if (reload == false) {
                    ...
                    $(
                        "#main_modal .ajax-submit, #main_modal .ajax-screen-submit"
    ...
    $(document).on("click", ".ajax-modal-2", function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (fullscreen == true) {
                    $("#secondary_modal >.modal-dialog").addClass(
                        "fullscreen-modal"
                    );
                } else {
                    $("#secondary_modal >.modal-dialog").removeClass(
                        "fullscreen-modal"
                    );
                }
            ...
            success: function (data) {
                ...
                if (json["result"] == "success") {
                    if (reload != false) {
                        ...
                        var select_value =
                            json["data"][target_select.data("value")];
                        var select_display =
                            json["data"][target_select.data("display")];
                    ...
                    if (Array.isArray(json["message"])) {
                        if (reload != false) {
                            ...
                            $("#main_modal .alert-primary").addClass("d-none");
                            $("#main_modal .alert-danger").removeClass(
                                "d-none"
                            );
                        } else {
                            //Secondary Modal
                ...
                if (json["result"] == "success") {
                    ...
                    if (json["action"] == "update") {
                        ...
                        $(new_row)
                            ...
                            .each(function () {
                                if (
                                    $(this).attr("class") == "dataTables_empty"
                                ) {
                                    window.location.reload();
                                }
                                if (
