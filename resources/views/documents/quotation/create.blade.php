        ...
        <div class="col-lg-10">
            <div class="card shadow-sm">
                ...
                <div class="card-body p-4">
                    ...
                    <!-- Quotation Form -->
                    <form id="quotationForm" action="{{ route('documents.quotation.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="quotation_date" name="quotation_date" value="{{ date('Y-m-d') }}">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="quotation_number" name="quotation_number" value="QT-{{ date('Ymd') }}-001">
                                </div>
                                <div class="mb-3">
