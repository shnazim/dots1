        ...
        <div class="col-lg-10">
            <div class="card shadow-sm">
                ...
                <div class="card-body p-4">
                    ...
                    <!-- PO Form -->
                    <form id="poForm" action="{{ route('documents.po.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="expected_delivery" name="expected_delivery" value="{{ date('Y-m-d', strtotime('+7 days')) }}">
                                </div>
                                <div class="mb-3">
                                    <label for="po_number" class="form-label">PO Number</label>
                                    <input type="text" class="form-control" id="po_number" name="po_number" value="PO-{{ date('Ymd') }}-001">
                                </div>
                                <div class="mb-3">
                        ...
                        <div class="row mt-4">
                            <div class="col-12 text-center">
                                <button type="submit" class="btn btn-info btn-lg me-3">
                                    <i class="fas fa-save me-2"></i>Generate Purchase Order
                                </button>
