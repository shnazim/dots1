        ...
        <div class="col-lg-10">
            <div class="card shadow-sm">
                ...
                <div class="card-body p-4">
                    ...
                    <!-- Invoice Form -->
                    <form id="invoiceForm" action="{{ route('documents.invoice.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="invoice_number" name="invoice_number" value="INV-{{ date('Ymd') }}-001">
                                </div>
                                <div class="mb-3">
