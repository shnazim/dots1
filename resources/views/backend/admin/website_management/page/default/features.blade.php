		...
		<div class="col-lg-8 offset-lg-2">
			<div class="card">
				<div class="card-header d-flex align-items-center justify-content-between">
					<span class="panel-title">{{ _lang('Update Features Page') }}</span>
					...
					<div class="row">
						<div class="col-md-6">
					        <div class="form-group">
						        ...
						        <input type="text" class="form-control" name="features_page[title]" value="{{ isset($pageData->title) ? $pageData->title : '' }}" required>
					        </div>
					    </div>
						...
						<div class="col-md-12">
					        <div class="form-group">
						        ...
						        <input type="text" class="form-control" name="features_page[features_heading]" value="{{ isset($pageData->features_heading) ? $pageData->features_heading : '' }}" required>
					        </div>
					    </div>
						...
						<div class="col-md-12">
					        <div class="form-group">
						        ...
						        <input type="text" class="form-control" name="features_page[features_sub_heading]" value="{{ isset($pageData->features_sub_heading) ? $pageData->features_sub_heading : '' }}">
					        </div>
					    </div>
