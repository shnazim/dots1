	...
	<div class="col-lg-12">
		<div class="card no-export">
		    <div class="card-header d-flex align-items-center">
				...
				<a class="btn btn-primary btn-xs ml-auto ajax-modal" data-title="{{ _lang('Add New FAQ') }}" href="{{ route('faqs.create') }}"><i class="ti-plus"></i>&nbsp;{{ _lang('Add New') }}</a>
			</div>
			<div class="card-body">
								...
								<span class="dropdown">
								  ...
								  <form action="{{ route('faqs.destroy', $faq->id) }}" method="post">
									...
									<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
										<a href="{{ route('faqs.edit', $faq->id) }}" data-title="{{ _lang('Update FAQ') }}" class="dropdown-item dropdown-edit ajax-modal"><i class="ti-pencil-alt"></i>&nbsp;{{ _lang('Edit') }}</a>
