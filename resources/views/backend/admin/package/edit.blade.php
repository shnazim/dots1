					...
					<div class="row">
						<div class="col-lg-12">
							...
							<div class="form-group row align-items-center">
								...
								<div class="col-xl-7">
									<input type="number" class="form-control" name="invoice_limit" value="{{ $package->invoice_limit != '-1' ? $package->invoice_limit : '' }}" placeholder="100">
								</div>

								<div class="col-xl-2">
									<div class="form-check">
										<label class="form-check-label text-danger">
											<input type="checkbox" class="form-check-input no-msg" name="invoice_limit" value="-1" {{ $package->invoice_limit == '-1' ? 'checked' : '' }}>{{ _lang('UNLIMITED') }}
										</label>
									</div>
								</div>
							</div>
							...
							<div class="form-group row align-items-center">
								...
								<div class="col-xl-7">
									<input type="number" class="form-control" name="quotation_limit" value="{{ $package->quotation_limit != '-1' ? $package->quotation_limit : '' }}" placeholder="150">
								</div>

								<div class="col-xl-2">
									<div class="form-check">
										<label class="form-check-label text-danger">
											<input type="checkbox" class="form-check-input no-msg" name="quotation_limit" value="-1" {{ $package->quotation_limit == '-1' ? 'checked' : '' }}>{{ _lang('UNLIMITED') }}
										</label>
									</div>
								</div>
							</div>
							...
							<div class="form-group row align-items-center">
								...
								<div class="col-xl-7">
									<select class="form-control auto-select" data-selected="{{ $package->recurring_invoice }}" name="recurring_invoice" required>
										<option value="0">{{ _lang('No') }}</option>
										<option value="1">{{ _lang('Yes') }}</option>
									</select>
								</div>
							...
							<div class="form-group row align-items-center">
								...
								<div class="col-xl-7">
									<input type="number" class="form-control" name="customer_limit" value="{{ $package->customer_limit != '-1' ? $package->customer_limit : '' }}" placeholder="100">
								</div>
								<div class="col-xl-2">
									<div class="form-check">
										<label class="form-check-label text-danger">
											<input type="checkbox" class="form-check-input no-msg" name="customer_limit" value="-1" {{ $package->customer_limit == '-1' ? 'checked' : '' }}>{{ _lang('UNLIMITED') }}
										</label>
									</div>
								</div>
							</div>
							...
							<div class="form-group row align-items-center">
								...
								<div class="col-xl-7">
									<input type="number" class="form-control" name="business_limit" value="{{ $package->business_limit != '-1' ? $package->business_limit : '' }}" placeholder="10">
								</div>
								<div class="col-xl-2">
									<div class="form-check">
										<label class="form-check-label text-danger">
							...
							<div class="form-group row align-items-center">
								...
								<div class="col-xl-7">
									<select class="form-control auto-select" data-selected="{{ $package->invoice_builder }}" name="invoice_builder" required>
							...
							<div class="form-group row align-items-center">
								...
								<div class="col-xl-7">
									<select class="form-control auto-select" data-selected="{{ $package->online_invoice_payment }}" name="online_invoice_payment" required>
										<option value="">{{ _lang('Select One') }}</option>
										<option value="0">{{ _lang('No') }}</option>
										<option value="1">{{ _lang('Yes') }}</option>
									</select>
