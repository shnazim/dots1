								...
								<table class="table" id="invoice-table">
									...
									<tbody>
										...
										<tr class="line-item">
											...
											<td class="input-xs text-center"><input type="number" class="form-control quantity" name="quantity[]" value="{{ $item->quantity }}" min="0.1" step="0.1"></td>
							...
							<div class="form-group">
								...
								<div class="input-group">
									<div class="input-group-prepend">
										<select class="form-control auto-select discount_type" id="discount_type" name="discount_type" data-selected="{{ $quotation->discount_type }}">
