	...
	<div class="col-lg-10 offset-lg-1">
		<div class="card">
			<div class="card-header d-sm-flex align-items-center justify-content-between">
				<span class="panel-title">{{ _lang('Purchase By Vendors') }}</span>
			...
			<div class="card-body">
				<div class="report-params">
					<form class="validate" method="post" action="{{ route('reports.purchase_by_vendor') }}">
						<div class="row">
              				{{ csrf_field() }}
							...
							<div class="col-lg-3">
								<div class="form-group">
									...
									<select class="form-control select2 auto-select" data-selected="{{ isset($vendor_id) ? $vendor_id : old('vendor_id') }}" name="vendor_id">
										<option value="">{{ _lang('All Vendor') }}</option>
