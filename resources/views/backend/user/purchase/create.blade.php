					...
					<div class="row">
						...
						<div class="col-lg-4 offset-lg-4">
							<div class="row">
								...
								<div class="col-md-12">
									<div class="form-group">
										<input type="text" class="form-control" name="bill_no" value="{{ get_business_option('purchase_bill_no', old('bill_no')) }}" placeholder="{{ _lang('Bill No') }}" required>
									</div>
								</div>

								<div class="col-md-12">
									<div class="form-group">
										<input type="text" class="form-control" name="po_so_number" value="{{ get_business_option('po_so_number', old('po_so_number')) }}" placeholder="{{ _lang('PO / SO Number') }}">
									</div>
								</div>
							</div>
						</div>
