...
@section('content')
<div class="row">
	@if(has_permission('dashboard.current_month_income_widget'))
	...
	@if(has_permission('dashboard.current_month_expense_widget'))
	<div class="col-xl-3 col-md-6">
	...
	@if(has_permission('dashboard.due_invoice_amount_widget'))
	<div class="col-xl-3 col-md-6">
	...
	@if(has_permission('dashboard.due_purchase_amount_widget'))
	<div class="col-xl-3 col-md-6">
...
@if(has_permission('dashboard.cashflow_widget'))
<div class="row">
...
<div class="row">
	@if(has_permission('dashboard.income_by_category_widget'))
	...
	@if(has_permission('dashboard.expense_by_category_widget'))
	<div class="col-lg-4 col-md-6 mb-4">
		<div class="card h-100">
			<div class="card-header d-flex align-items-center">
	...
	@if(has_permission('dashboard.account_balance_widget'))
...
@if(has_permission('dashboard.recent_transaction_widget'))
<div class="row">
	<div class="col-lg-12">
		<div class="card mb-4">
