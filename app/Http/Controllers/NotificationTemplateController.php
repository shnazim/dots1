...
class NotificationTemplateController extends Controller {
    ...
    public function index() {
        ...
        return view('backend.admin.administration.notification_template.list', compact('emailtemplates','assets'));
    }
    ...
    public function show(Request $request, $id) {
        ...
        if (!$request->ajax()) {
            return view('backend.admin.administration.notification_template.view', compact('emailtemplate', 'id'));
        } else {
            return view('backend.admin.administration.notification_template.modal.view', compact('emailtemplate', 'id'));
        }
    ...
    public function edit(Request $request, $id) {
        $assets = ['tinymce'];
        $emailtemplate = EmailTemplate::find($id); 
        return view('backend.admin.administration.notification_template.edit', compact('emailtemplate', 'id', 'assets'));
    }
