...
class UtilityController extends Controller {
	...
	public function settings(Request $request, $store = '') {
		if ($store == '') {
			return view('backend.admin.administration.general_settings.settings');
		} else {
	...
	public function system_settings(Request $request, $view = '') {
		if ($request->isMethod('get')) {
			return view("backend.admin.administration.general_settings.$view");
	...
	public function theme_option(Request $request, $store = '') {
		if ($store == '') {
			return view("backend.admin.administration.general_settings.theme_option");
		} else {
			foreach ($_POST as $key => $value) {
				if ($key == "_token") {
					continue;
	...
	public function database_backup_list() {
		...
		return view('backend.admin.administration.database_backup.list', compact('databasebackups', 'assets'));
	}
