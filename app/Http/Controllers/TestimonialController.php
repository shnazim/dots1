...
class TestimonialController extends Controller {
    ...
    public function index() {
        ...
        return view('backend.admin.website_management.testimonial.list', compact('testimonials', 'assets'));
    }
    ...
    public function create(Request $request) {
        if (!$request->ajax()) {
            ...
            return view('backend.admin.website_management.testimonial.modal.create');
        }
    }
    ...
    public function edit(Request $request, $id) {
        ...
        if (!$request->ajax()) {
            ...
            return view('backend.admin.website_management.testimonial.modal.edit', compact('testimonial', 'id'));
        }
